...
> [!Hint]
> Markdown エディタに Obsidian を使用している場合、`createdAt`、`updatedAt` については書きのどちらかで扱うと楽です。
> 
